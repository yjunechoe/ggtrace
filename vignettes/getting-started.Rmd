...
- We can get pretty far using `{ggtrace}` to just focus on understanding the part of the internals that takes the user-supplied data and turns it into a "drawing-ready" data.
