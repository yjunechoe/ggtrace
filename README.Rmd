...
More on the 📦 pkgdown website: [https://yjunechoe.github.io/ggtrace](https://yjunechoe.github.io/ggtrace)
...
Actually, `"compute_panel"` method is not defined for `StatBoxplot`, which means that it's being inherited. 
...
lapply(sina_tracedump, function(df) { df$x })
```
