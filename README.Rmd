...
- **Flexible** 🛠
    ...
    - Since `ggtrace()` doesn't rely on interactivity or side effects, it's ideal for constructing targeted reproducible examples (e.g., with `{reprex}`)
    - Works with other object classes in R (e.g., R6), not just ggproto!
