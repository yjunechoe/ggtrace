...
Note that `{ggtrace}` is [routinely checked](https://github.com/yjunechoe/ggtrace/actions/workflows/test-with-dev-ggplot2.yaml) against the dev version of `{ggplot2}`.
